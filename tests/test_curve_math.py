...
class TestCryptoMath:
    def test_golden_value(self):
        ...
        assert dy == 2_999_314_424_279_659_293
    ...
    def test_newton_D_matches_deployed(self):
        xp = [3204135904013000000000000, 3155421422034042625598814, 3159814849399252252000799]
        assert m.newton_D(1707629, 11809167828997, xp) == 9519299633910278200585301
